...
These two ranges can be directly mapping to corresponding classes. Optionally, a static factory method to create the range can be provided (if it allows for a shorter more fluent syntax, eg. static import in Java).
...
addFacets(SearchFacet.numeric("strength", "abv", 3,
	numericRange("strong", 5),
	numericRange("middle", 3.1, 4.99),
	numericRange("light", 0, 3.0));

addFacets(SearchFacet.date("age", "updated", 2,
	dateRange("old", null, "2016-01-01T00:00:00"),
	dateRange("thisYear", "2016-01-01T00:00:01"),
	dateRange("theYear2011", "2011-01-01T00:00:00", "2011-12-31T23:59:59"));
```
