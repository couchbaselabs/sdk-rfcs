...
# Unresolved Questions
 - (brett) **A Facet's name is not a component of the Facet but rather of the SearchParams. As such, it should not be part of `SearchFacet` but rather a first parameter of the `SearchParams.addFacet` method**
