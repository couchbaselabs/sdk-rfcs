...
- [General Design](#general-design)
	...
	- [3. Request Query Options](#3-request-query-options)
		...
		- [3.13. Compound Queries - Boolean Query](#313-compound-queries-boolean-query)
			- [Min](#min)
		- [3.14. Wildcard Query Options](#314-wildcard-query-options)
			- [Wildcard](#wildcard)
			- [Field](#field)
		- [3.15. DocId Query Options](#315-docid-query-options)
			- [DocIds constructor parameter](#docids-constructor-parameter)
		- [3.16. Boolean Field Query Options](#316-boolean-field-query-options)
			- [Boolean value](#boolean-value)
			- [Field](#field)
		- [3.17. MatchAll Query Options](#317-matchall-query-options)
		- [3.18. MatchNone Query Options](#318-matchnone-query-options)
...
### 3.16. Boolean Field Query Options
