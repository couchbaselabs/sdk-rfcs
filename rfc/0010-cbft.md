...
| Builder Name | Request Path | Wire Type | Default | Constraints |
| ------------ | ------------ | --------- | ------- | ----------- |
| `addFacets(SearchFacet...)`    | `facets`     | JSON Object of Objects `{name: {facet}, name: {facet}...}` | - | For a single facet, either `numeric_ranges` or `date_ranges` is allowed. If omitted it is a term facet. |
...
| Builder Name | Request Path | Wire Type | Default | Constraints |
| ------------ | ------------ | --------- | ------- | ----------- |
| `minShould(int min)` | `query.should.min` | JSON Number in the disjunction query object | 1 | - |
