...
# Unresolved Questions
 - (brett) **A Facet's name is not a component of the Facet but rather of the SearchQuery. As such, it should not be part of `SearchFacet` but rather a first parameter of the `SearchQuery.addFacet` method**
